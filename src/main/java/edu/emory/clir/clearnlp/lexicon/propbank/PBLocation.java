/**
 * Copyright 2014, Emory University <p/> Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file
...
public class PBLocation implements Serializable, Comparable<PBLocation> {
    ...
    public static final String ORIGINAL_LOC = "#";
